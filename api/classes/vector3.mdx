...
description: "Reference for the Vector3 class in RollingQuest Lua scripts. Covers x/y/z properties, static constants, and methods: lerp, cross, dot, distance, and more."
