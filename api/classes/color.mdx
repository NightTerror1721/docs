...
description: "Reference for the Color class in RollingQuest Lua scripts. Covers RGBA constructors, grayscale shortcuts, static color constants, lerp blending, and usage with the Dialog namespace."
sidebarTitle: "Color"
---
