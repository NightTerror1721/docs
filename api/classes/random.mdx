...
description: "Reference for the Random class in RollingQuest Lua scripts. Covers seeded constructors, nextInteger, nextNumber, nextBoolean, nextElement, shuffle, serialization, and practical examples."
sidebarTitle: "Random"
---
