...
description: "Reference for the Timer class in RollingQuest Lua scripts. Covers start, stop, addTime, and subtractTime overloads, plus cooldown and callback patterns."
sidebarTitle: "Timer"
---
