...
description: "Reference for the Quaternion class in RollingQuest Lua scripts. Covers x/y/z/w, eulerAngles, slerp, lerp, angleAxis, lookRotation, and rotateTowards."
