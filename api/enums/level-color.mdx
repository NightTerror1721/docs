...
description: "LevelColor enum for RollingQuest scripts — twelve portal-side colors from Red (0) through White (11) for retrieving and configuring portal sides."
