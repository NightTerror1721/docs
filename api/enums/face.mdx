---
title: "Face Enum Reference for RollingQuest Scripts"
description: "Complete reference for the Face enum, which identifies one of the six sides of a block cube in RollingQuest Lua scripts."
sidebarTitle: "Face"
---
