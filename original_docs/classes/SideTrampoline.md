...
```lua
---@type Vector3
SideTrampoline.bitangentVector
```
...
--- @return Basis
function SideTrampoline:getAssociatedBasis(orientation)
```
...
```lua
--- @return Basis
function SideTrampoline:getAssociatedBasis()
```
...
--- @param orientation Orientation
--- @return boolean
function SideTrampoline:isDirectionBlocked(orientation)
```
...
```lua
--- @return Level
function SideTrampoline:asLevel()
```
...
```lua
--- @return Block
function SideTrampoline:asBlock()
```
...
```lua
--- @return Side
function SideTrampoline:asSide()
```
...
```lua
--- @return Item
function SideTrampoline:asItem()
```
...
```lua
--- @return Enemy
function SideTrampoline:asEnemy()
```
...
```lua
--- @return Ball
function SideTrampoline:asBall()
```
...
```lua
--- @return Decoration
function SideTrampoline:asDecoration()
```
