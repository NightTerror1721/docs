...
```lua
---@type Vector3
SidePortalExit.bitangentVector
```
...
--- @return Basis
function SidePortalExit:getAssociatedBasis(orientation)
```
...
```lua
--- @return Basis
function SidePortalExit:getAssociatedBasis()
```
...
--- @param orientation Orientation
--- @return boolean
function SidePortalExit:isDirectionBlocked(orientation)
```
...
```lua
--- @return Level
function SidePortalExit:asLevel()
```
...
```lua
--- @return Block
function SidePortalExit:asBlock()
```
...
```lua
--- @return Side
function SidePortalExit:asSide()
```
...
```lua
--- @return Item
function SidePortalExit:asItem()
```
...
```lua
--- @return Enemy
function SidePortalExit:asEnemy()
```
...
```lua
--- @return Ball
function SidePortalExit:asBall()
```
...
```lua
--- @return Decoration
function SidePortalExit:asDecoration()
```
