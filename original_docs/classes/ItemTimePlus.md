...
```lua
---@type boolean
ItemTimePlus.developerModeOnly
```
...
--- @return any
function ItemTimePlus:collect(collectorBall)
```
...
```lua
--- @return Decoration
function ItemTimePlus:asDecoration()
```
