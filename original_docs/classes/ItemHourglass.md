...
```lua
---@type boolean
ItemHourglass.developerModeOnly
```
...
--- @return any
function ItemHourglass:collect(collectorBall)
```
...
```lua
--- @return any
function ItemHourglass:disable()
```
...
```lua
--- @return Level
function ItemHourglass:asLevel()
```
...
```lua
--- @return Block
function ItemHourglass:asBlock()
```
...
```lua
--- @return Enemy
function ItemHourglass:asEnemy()
```
...
```lua
--- @return Decoration
function ItemHourglass:asDecoration()
```
