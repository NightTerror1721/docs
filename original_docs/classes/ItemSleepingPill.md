...
```lua
---@type integer
ItemSleepingPill.treasureScore
```
...
```lua
---@type boolean
ItemSleepingPill.developerModeOnly
```
...
--- @return any
function ItemSleepingPill:collect(collectorBall)
```
...
```lua
--- @return any
function ItemSleepingPill:enable()
```
...
```lua
--- @return any
function ItemSleepingPill:disable()
```
...
```lua
--- @return Level
function ItemSleepingPill:asLevel()
```
...
```lua
--- @return Block
function ItemSleepingPill:asBlock()
```
...
```lua
--- @return Side
function ItemSleepingPill:asSide()
```
...
```lua
--- @return Item
function ItemSleepingPill:asItem()
```
...
```lua
--- @return Enemy
function ItemSleepingPill:asEnemy()
```
...
```lua
--- @return Ball
function ItemSleepingPill:asBall()
```
...
```lua
--- @return Decoration
function ItemSleepingPill:asDecoration()
```
