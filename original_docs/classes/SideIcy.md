...
--- @return any
function SideIcy:press(playSound)
```
...
--- @return Basis
function SideIcy:getAssociatedBasis(orientation)
```
...
```lua
--- @return Basis
function SideIcy:getAssociatedBasis()
```
...
--- @param orientation Orientation
--- @return boolean
function SideIcy:isDirectionBlocked(orientation)
```
