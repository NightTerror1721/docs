...
```lua
---@type boolean
ItemTimeMinus.developerModeOnly
```
...
--- @return any
function ItemTimeMinus:collect(collectorBall)
```
...
```lua
--- @return any
function ItemTimeMinus:disable()
```
...
```lua
--- @return Level
function ItemTimeMinus:asLevel()
```
...
```lua
--- @return Block
function ItemTimeMinus:asBlock()
```
...
```lua
--- @return Enemy
function ItemTimeMinus:asEnemy()
```
...
```lua
--- @return Decoration
function ItemTimeMinus:asDecoration()
```
