...
--- @return Basis
function SideTimeStop:getAssociatedBasis(orientation)
```
...
```lua
--- @return Basis
function SideTimeStop:getAssociatedBasis()
```
...
--- @param orientation Orientation
--- @return boolean
function SideTimeStop:isDirectionBlocked(orientation)
```
...
```lua
--- @return Decoration
function SideTimeStop:asDecoration()
```
