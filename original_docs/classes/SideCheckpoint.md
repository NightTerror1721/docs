...
```lua
---@type Vector3
SideCheckpoint.bitangentVector
```
...
--- @return Basis
function SideCheckpoint:getAssociatedBasis(orientation)
```
...
```lua
--- @return Basis
function SideCheckpoint:getAssociatedBasis()
```
...
--- @param orientation Orientation
--- @return boolean
function SideCheckpoint:isDirectionBlocked(orientation)
```
...
```lua
--- @return Level
function SideCheckpoint:asLevel()
```
...
```lua
--- @return Block
function SideCheckpoint:asBlock()
```
...
```lua
--- @return Side
function SideCheckpoint:asSide()
```
...
```lua
--- @return Item
function SideCheckpoint:asItem()
```
...
```lua
--- @return Enemy
function SideCheckpoint:asEnemy()
```
...
```lua
--- @return Ball
function SideCheckpoint:asBall()
```
...
```lua
--- @return Decoration
function SideCheckpoint:asDecoration()
```
...
Specific events that `SideCheckpoint` can trigger and that are captured with the `OnCustomEvent` hook.
