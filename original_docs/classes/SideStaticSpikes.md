...
```lua
---@type Vector3
SideStaticSpikes.centerPosition
```
...
```lua
---@type Vector3
SideStaticSpikes.tangentVector
```
...
```lua
---@type Vector3
SideStaticSpikes.bitangentVector
```
...
```lua
---@type boolean
SideStaticSpikes.hasDecoration
```
...
--- @return Basis
function SideStaticSpikes:getAssociatedBasis(orientation)
```
...
```lua
--- @return Basis
function SideStaticSpikes:getAssociatedBasis()
```
...
--- @param orientation Orientation
--- @return boolean
function SideStaticSpikes:isDirectionBlocked(orientation)
```
...
```lua
--- @return Level
function SideStaticSpikes:asLevel()
```
...
```lua
--- @return Block
function SideStaticSpikes:asBlock()
```
...
```lua
--- @return Side
function SideStaticSpikes:asSide()
```
...
```lua
--- @return Item
function SideStaticSpikes:asItem()
```
...
```lua
--- @return Enemy
function SideStaticSpikes:asEnemy()
```
...
```lua
--- @return Ball
function SideStaticSpikes:asBall()
```
...
```lua
--- @return Decoration
function SideStaticSpikes:asDecoration()
```
