...
```lua
--- @return any
function BlockToggle:deactivate()
```
...
--- @param face Face
--- @return Side
function BlockToggle:getSide(face)
```
...
```lua
--- @return any
function BlockToggle:markAsVisited()
```
...
```lua
--- @return Decoration
function BlockToggle:asDecoration()
```
