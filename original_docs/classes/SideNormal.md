...
--- @return Basis
function SideNormal:getAssociatedBasis(orientation)
```
...
```lua
--- @return Basis
function SideNormal:getAssociatedBasis()
```
...
--- @param orientation Orientation
--- @return boolean
function SideNormal:isDirectionBlocked(orientation)
```
...
```lua
--- @return Decoration
function SideNormal:asDecoration()
```
