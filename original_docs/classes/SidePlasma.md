...
--- @return Basis
function SidePlasma:getAssociatedBasis(orientation)
```
...
```lua
--- @return Basis
function SidePlasma:getAssociatedBasis()
```
...
--- @param orientation Orientation
--- @return boolean
function SidePlasma:isDirectionBlocked(orientation)
```
...
```lua
--- @return Decoration
function SidePlasma:asDecoration()
```
