...
```lua
---@type integer
ItemGravityArrow.treasureScore
```
...
```lua
---@type boolean
ItemGravityArrow.developerModeOnly
```
...
--- @return any
function ItemGravityArrow:collect(collectorBall)
```
...
```lua
--- @return any
function ItemGravityArrow:enable()
```
...
```lua
--- @return any
function ItemGravityArrow:disable()
```
...
```lua
--- @return Level
function ItemGravityArrow:asLevel()
```
...
```lua
--- @return Block
function ItemGravityArrow:asBlock()
```
...
```lua
--- @return Side
function ItemGravityArrow:asSide()
```
...
```lua
--- @return Item
function ItemGravityArrow:asItem()
```
...
```lua
--- @return Enemy
function ItemGravityArrow:asEnemy()
```
...
```lua
--- @return Ball
function ItemGravityArrow:asBall()
```
...
```lua
--- @return Decoration
function ItemGravityArrow:asDecoration()
```
