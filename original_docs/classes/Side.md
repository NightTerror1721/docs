...
Represents a side of a block. Provides access to its properties and associated elements.
...
```lua
--- @return Basis
function Side:getAssociatedBasis()
```
