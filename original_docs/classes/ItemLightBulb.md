...
```lua
---@type boolean
ItemLightBulb.developerModeOnly
```
...
--- @return any
function ItemLightBulb:collect(collectorBall)
```
...
```lua
--- @return any
function ItemLightBulb:disable()
```
...
```lua
--- @return Level
function ItemLightBulb:asLevel()
```
...
```lua
--- @return Block
function ItemLightBulb:asBlock()
```
...
```lua
--- @return Enemy
function ItemLightBulb:asEnemy()
```
...
```lua
--- @return Decoration
function ItemLightBulb:asDecoration()
```
