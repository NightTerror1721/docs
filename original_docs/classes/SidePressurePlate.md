...
```lua
---@type Vector3
SidePressurePlate.centerPosition
```
...
```lua
---@type Vector3
SidePressurePlate.normalVector
```
...
```lua
---@type Vector3
SidePressurePlate.tangentVector
```
...
```lua
---@type Vector3
SidePressurePlate.bitangentVector
```
...
```lua
---@type boolean
SidePressurePlate.isIntangible
```
...
```lua
---@type boolean
SidePressurePlate.hasDecoration
```
...
--- @return Basis
function SidePressurePlate:getAssociatedBasis(orientation)
```
...
```lua
--- @return Basis
function SidePressurePlate:getAssociatedBasis()
```
...
--- @param orientation Orientation
--- @return boolean
function SidePressurePlate:isDirectionBlocked(orientation)
```
...
```lua
--- @return Level
function SidePressurePlate:asLevel()
```
...
```lua
--- @return Block
function SidePressurePlate:asBlock()
```
...
```lua
--- @return Side
function SidePressurePlate:asSide()
```
...
```lua
--- @return Item
function SidePressurePlate:asItem()
```
...
```lua
--- @return Enemy
function SidePressurePlate:asEnemy()
```
...
```lua
--- @return Ball
function SidePressurePlate:asBall()
```
...
```lua
--- @return Decoration
function SidePressurePlate:asDecoration()
```
...
Specific events that `SidePressurePlate` can trigger and that are captured with the `OnCustomEvent` hook.
