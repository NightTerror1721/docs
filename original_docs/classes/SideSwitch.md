...
--- @return any
function SideSwitch:switch(playSound)
```
...
--- @return Basis
function SideSwitch:getAssociatedBasis(orientation)
```
...
```lua
--- @return Basis
function SideSwitch:getAssociatedBasis()
```
...
--- @param orientation Orientation
--- @return boolean
function SideSwitch:isDirectionBlocked(orientation)
```
...
```lua
--- @return Decoration
function SideSwitch:asDecoration()
```
