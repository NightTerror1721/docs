...
```lua
--- @return any
function SideTeslaCoil:activate()
```
...
```lua
--- @return any
function SideTeslaCoil:deactivate()
```
...
--- @return Basis
function SideTeslaCoil:getAssociatedBasis(orientation)
```
...
```lua
--- @return Basis
function SideTeslaCoil:getAssociatedBasis()
```
...
--- @param orientation Orientation
--- @return boolean
function SideTeslaCoil:isDirectionBlocked(orientation)
```
...
```lua
--- @return Level
function SideTeslaCoil:asLevel()
```
...
```lua
--- @return Block
function SideTeslaCoil:asBlock()
```
...
```lua
--- @return Enemy
function SideTeslaCoil:asEnemy()
```
...
```lua
--- @return Decoration
function SideTeslaCoil:asDecoration()
```
