...
```lua
---@type integer
SidePatternSpike.currentPatternIndex
```
...
```lua
---@type string
SidePatternSpike.currentPatternSymbol
```
...
```lua
---@type integer
SidePatternSpike.initialPatternIndex
```
...
```lua
---@type Vector3
SidePatternSpike.centerPosition
```
...
```lua
---@type Vector3
SidePatternSpike.tangentVector
```
...
```lua
---@type Vector3
SidePatternSpike.bitangentVector
```
...
```lua
---@type boolean
SidePatternSpike.hasDecoration
```
...
--- @return Basis
function SidePatternSpike:getAssociatedBasis(orientation)
```
...
```lua
--- @return Basis
function SidePatternSpike:getAssociatedBasis()
```
...
--- @param orientation Orientation
--- @return boolean
function SidePatternSpike:isDirectionBlocked(orientation)
```
...
```lua
--- @return Level
function SidePatternSpike:asLevel()
```
...
```lua
--- @return Block
function SidePatternSpike:asBlock()
```
...
```lua
--- @return Side
function SidePatternSpike:asSide()
```
...
```lua
--- @return Item
function SidePatternSpike:asItem()
```
...
```lua
--- @return Enemy
function SidePatternSpike:asEnemy()
```
...
```lua
--- @return Ball
function SidePatternSpike:asBall()
```
...
```lua
--- @return Decoration
function SidePatternSpike:asDecoration()
```
...
Specific events that `SidePatternSpike` can trigger and that are captured with the `OnCustomEvent` hook.
