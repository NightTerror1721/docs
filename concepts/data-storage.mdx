---
title: "Storing and Sharing Data Between Scripts"
...
### Reading and Writing with `LocalData`
...
`LocalData` exposes the same typed API as `RawLocalData` (`setBool`, `getInteger`, `setString`, etc.).
