---
title: "Script Communication with Signals"
description: "Learn how to send messages between entities in RollingQuest using the Signals namespace and the OnSignal hook."
