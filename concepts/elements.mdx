---
title: "Looking Up Entities with the Elements Namespace"
description: "Use Elements.tagged to find any entity in the level by its tag, then cast it to the right type to call methods on it."
